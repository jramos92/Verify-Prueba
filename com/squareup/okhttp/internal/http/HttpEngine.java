...
public final class HttpEngine
{
    ...
    throws RequestException
  {
    ...
    if ((str == null) || (str.length() == 0)) {
      throw new RequestException(new UnknownHostException(paramRequest.url().toString()));
    }
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\squareup\okhttp\internal\http\HttpEngine.class
