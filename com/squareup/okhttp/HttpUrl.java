  ...
  public static final class Builder
  {
    ...
    private static String canonicalizeHost(String paramString, int paramInt1, int paramInt2)
    {
      ...
      do
      {
        ...
        {
          return paramString;
          localObject2 = domainToAscii(paramString);
          paramString = (String)localObject1;
        } while (localObject2 == null);
        paramInt1 = ((String)localObject2).length();
        paramString = (String)localObject1;
      } while (HttpUrl.delimiterOffset((String)localObject2, 0, paramInt1, "\000\t\n\r #%/:?@[\\]") != paramInt1);
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\squareup\okhttp\HttpUrl.class
