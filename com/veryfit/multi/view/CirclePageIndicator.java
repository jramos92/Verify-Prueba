  ...
  implements PageIndicator
{
  ...
  public CirclePageIndicator(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    int i = ((Resources)localObject).getColor(2131099667);
    int j = ((Resources)localObject).getColor(2131099666);
    float f = ((Resources)localObject).getDimension(2131165189);
    paramAttributeSet = paramContext.obtainStyledAttributes(paramAttributeSet, R.styleable.CirclePageIndicator, paramInt, 0);
    this.mCentered = paramAttributeSet.getBoolean(2, true);
    this.mOrientation = paramAttributeSet.getInt(0, 0);
    this.mPaintPageFill.setStyle(Paint.Style.FILL);
    this.mPaintPageFill.setColor(paramAttributeSet.getColor(4, i));
    this.mPaintStroke.setStyle(Paint.Style.STROKE);
    this.mPaintStroke.setColor(paramAttributeSet.getColor(7, 0));
    this.mPaintStroke.setStrokeWidth(paramAttributeSet.getDimension(8, 1.0F));
    this.mPaintFill.setStyle(Paint.Style.FILL);
    this.mPaintFill.setColor(paramAttributeSet.getColor(3, j));
    this.mRadius = paramAttributeSet.getDimension(5, f);
    this.mSnap = paramAttributeSet.getBoolean(6, false);
  ...
  private int measureLong(int paramInt)
  {
    ...
    do
    {
      ...
      j = (int)(getPaddingLeft() + getPaddingRight() + paramInt * 3 * this.mRadius + (paramInt - 1) * this.mRadius + 1.0F);
      paramInt = j;
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\veryfit\multi\view\CirclePageIndicator.class
