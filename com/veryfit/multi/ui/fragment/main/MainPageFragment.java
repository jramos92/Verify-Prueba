  ...
  implements View.OnClickListener, NotifyParentFragment, ShareCtrl.OnShareListener
{
  ...
  private APPCoreServiceListener mCoreServiceListener = new APPCoreServiceListener()
  {
    public void onBLEConnected()
    {
      ...
      MainPageFragment.this.dialog.setTitle(MainPageFragment.this.getActivity().getResources().getString(2131296743));
  ...
  private void initView()
  {
    ...
    this.backToday = ((TextView)this.mRootView.findViewById(2131231004));
    this.backToday.setOnClickListener(this);
    this.scrollView = ((MainPageRelativeLayout)this.mRootView.findViewById(2131230999));
    this.scrollView.init(this);
    this.dateView = ((CheckBox)this.mRootView.findViewById(2131231002));
    setDate(this.dateOffset);
    this.dateView.setOnClickListener(this);
    this.pager = ((ViewPager)this.mRootView.findViewById(2131230973));
    ...
    CirclePageIndicator localCirclePageIndicator = (CirclePageIndicator)this.mRootView.findViewById(2131230835);
    localCirclePageIndicator.setViewPager(this.pager);
    localCirclePageIndicator.setOnPageChangeListener(this.pageChangeListener);
    this.imgBtn_share = ((ImageButton)this.mRootView.findViewById(2131231001));
  ...
  private void setDate(int paramInt)
  {
    if (paramInt == 0)
    {
      this.dateView.setText(2131296397);
      return;
    }
  ...
  public void handTimeZone()
  {
    ...
    if (!this.mAppSharedPreferences.getTimeZone().equals(""))
    {
      if (!this.mAppSharedPreferences.getTimeZone().equals(TimeZoneUtil.getCurrentTimeZone()))
      {
        ...
        this.dialog.setTitle(getActivity().getResources().getString(2131296744));
        this.dialog.show();
      }
      return;
    }
  ...
  public void onClick(View paramView)
  {
    ...
    {
      Toast.makeText(getActivity(), 2131296632, 0).show();
      return;
    }
      ...
      public void onShareSelect(int paramAnonymousInt)
      {
        if (NetUtils.isConnected(MainPageFragment.this.getActivity()))
        {
          ...
          case 9: 
            ...
            Util.showToast(MainPageFragment.this.getActivity(), 2131296778, 1);
            return;
          case 8: 
        ...
        Toast.makeText(MainPageFragment.this.getActivity(), 2131296632, 0).show();
      }
    });
  }
    ...
    getActivity().runOnUiThread(new Runnable()
    {
      public void run()
      {
        ...
        default: 
          return;
        case 5: 
          MainPageFragment.this.showToastShort(2131296639);
          return;
        case 6: 
          MainPageFragment.this.showToastShort(2131296640);
          return;
        case 8: 
          MainPageFragment.this.showToastShort(2131296773);
          return;
        }
        MainPageFragment.this.showToastShort(2131296775);
      }
    });
  }
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, @Nullable ViewGroup paramViewGroup, @Nullable Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      this.mRootView = paramLayoutInflater.inflate(2130903096, paramViewGroup, false);
      initView();
    ...
    getActivity().runOnUiThread(new Runnable()
    {
      public void run()
      {
        ...
        default: 
          return;
        case 1: 
          MainPageFragment.this.showToastShort(2131296634);
          return;
        case 2: 
        case 3: 
          MainPageFragment.this.showToastShort(2131296635);
          return;
        case 4: 
          MainPageFragment.this.showToastShort(2131296636);
          return;
        case 5: 
          MainPageFragment.this.showToastShort(2131296637);
          return;
        case 6: 
          MainPageFragment.this.showToastShort(2131296638);
          return;
        case 7: 
          MainPageFragment.this.showToastShort(2131296766);
          return;
        case 9: 
          MainPageFragment.this.showToastShort(2131296767);
          return;
        case 8: 
          MainPageFragment.this.showToastShort(2131296768);
          return;
        case 10: 
          MainPageFragment.this.showToastShort(2131296769);
          return;
        }
        MainPageFragment.this.showToastShort(2131296770);
      }
    });
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\veryfit\multi\ui\fragment\main\MainPageFragment.class
