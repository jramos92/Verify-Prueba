...
{
  public static final zze.zza zzanA = new zze.zza()
  {
    public void zzb(DataHolder paramAnonymousDataHolder)
    {
      zzne.zze(paramAnonymousDataHolder);
    }
  ...
  private static void zzc(DataHolder paramDataHolder)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: invokevirtual 47	com/google/android/gms/common/data/DataHolder:zzor	()Landroid/os/Bundle;
    //   6: ldc 36
    ...
    //   21: return
    //   22: aload_2
    //   23: invokestatic 57	com/google/android/gms/internal/zzne:zzf	(Lcom/google/android/gms/common/data/DataHolder;)Landroid/support/v4/util/LongSparseArray;
    //   26: astore_3
    ...
    //   51: aload_0
    //   52: iload_1
    //   53: invokevirtual 68	com/google/android/gms/common/data/DataHolder:zzbt	(I)I
    ...
    //   74: iload_1
    //   75: aload 5
    //   77: invokevirtual 84	com/google/android/gms/drive/metadata/internal/AppVisibleCustomProperties$zza:zzrI	()Lcom/google/android/gms/drive/metadata/internal/AppVisibleCustomProperties;
    //   80: invokevirtual 88	android/util/SparseArray:append	(ILjava/lang/Object;)V
    //   83: goto +51 -> 134
    //   86: aload_0
    //   87: invokevirtual 47	com/google/android/gms/common/data/DataHolder:zzor	()Landroid/os/Bundle;
    //   90: ldc 34
    //   92: aload 4
    ...
    //   101: aload_0
    //   102: invokevirtual 47	com/google/android/gms/common/data/DataHolder:zzor	()Landroid/os/Bundle;
    //   105: ldc 36
    ...
    //   123: aload_0
    //   124: invokevirtual 47	com/google/android/gms/common/data/DataHolder:zzor	()Landroid/os/Bundle;
    //   127: ldc 36
  ...
  {
    Bundle localBundle = paramDataHolder.zzor();
    if (localBundle == null) {
      return;
    }
    try
  ...
  {
    Object localObject1 = paramDataHolder.zzor();
  ...
  protected AppVisibleCustomProperties zzl(DataHolder paramDataHolder, int paramInt1, int paramInt2)
  {
    ...
    return (AppVisibleCustomProperties)localSparseArray2.get(paramInt1, AppVisibleCustomProperties.zzamA);
  }
}


/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\internal\zzne.class
