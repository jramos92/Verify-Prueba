...
public abstract interface zzjp
  extends IInterface
{
  public abstract void zza(GetRecentContextCall.Request paramRequest, zzjq paramzzjq)
    throws RemoteException;
  
  public abstract void zza(zzjq paramzzjq)
    throws RemoteException;
  
  public abstract void zza(zzjq paramzzjq, String paramString1, String paramString2)
    throws RemoteException;
  
  public abstract void zza(zzjq paramzzjq, String paramString, UsageInfo[] paramArrayOfUsageInfo)
    throws RemoteException;
  
  public abstract void zza(zzjq paramzzjq, boolean paramBoolean)
    throws RemoteException;
  
  public abstract void zzb(zzjq paramzzjq)
    throws RemoteException;
  ...
  public static abstract class zza
    ...
    implements zzjp
  {
    public static zzjp zzag(IBinder paramIBinder)
    {
      ...
      if ((localIInterface != null) && ((localIInterface instanceof zzjp))) {
        return (zzjp)localIInterface;
      }
      ...
      throws RemoteException
    {
      ...
      case 1: 
        ...
        zza(zzjq.zza.zzah(paramParcel1.readStrongBinder()), paramParcel1.readString(), (UsageInfo[])paramParcel1.createTypedArray(UsageInfo.CREATOR));
        paramParcel2.writeNoException();
        return true;
      case 2: 
        paramParcel1.enforceInterface("com.google.android.gms.appdatasearch.internal.ILightweightAppDataSearch");
        zza(zzjq.zza.zzah(paramParcel1.readStrongBinder()));
        paramParcel2.writeNoException();
        return true;
      case 3: 
        paramParcel1.enforceInterface("com.google.android.gms.appdatasearch.internal.ILightweightAppDataSearch");
        zzb(zzjq.zza.zzah(paramParcel1.readStrongBinder()));
        paramParcel2.writeNoException();
        return true;
      case 4: 
        paramParcel1.enforceInterface("com.google.android.gms.appdatasearch.internal.ILightweightAppDataSearch");
        localObject = zzjq.zza.zzah(paramParcel1.readStrongBinder());
        if (paramParcel1.readInt() != 0) {}
        for (boolean bool = true;; bool = false)
        {
          zza((zzjq)localObject, bool);
          paramParcel2.writeNoException();
          return true;
        }
      case 5: 
        ...
        {
          zza((GetRecentContextCall.Request)localObject, zzjq.zza.zzah(paramParcel1.readStrongBinder()));
          paramParcel2.writeNoException();
          return true;
        }
      }
      paramParcel1.enforceInterface("com.google.android.gms.appdatasearch.internal.ILightweightAppDataSearch");
      zza(zzjq.zza.zzah(paramParcel1.readStrongBinder()), paramParcel1.readString(), paramParcel1.readString());
      paramParcel2.writeNoException();
      return true;
    }
      ...
      implements zzjp
    {
      ...
      public void zza(GetRecentContextCall.Request paramRequest, zzjq paramzzjq)
        throws RemoteException
      {
        ...
        for (;;)
        {
          try
          {
            ...
            if (paramRequest != null)
            {
              ...
              if (paramzzjq != null)
              {
                paramRequest = paramzzjq.asBinder();
      ...
      /* Error */
      public void zza(zzjq paramzzjq)
        throws RemoteException
      {
        // Byte code:
        ...
        //   30: aload_0
        //   31: getfield 18	com/google/android/gms/internal/zzjp$zza$zza:zznJ	Landroid/os/IBinder;
        //   34: iconst_2
        //   35: aload_2
        //   36: aload_3
        //   37: iconst_0
      ...
      /* Error */
      public void zza(zzjq paramzzjq, String paramString1, String paramString2)
        throws RemoteException
      {
        // Byte code:
        //   0: invokestatic 30	android/os/Parcel:obtain	()Landroid/os/Parcel;
        ...
        //   46: aload_0
        //   47: getfield 18	com/google/android/gms/internal/zzjp$zza$zza:zznJ	Landroid/os/IBinder;
        //   50: bipush 6
        //   52: aload 4
        //   54: aload 5
        //   56: iconst_0
      ...
      /* Error */
      public void zza(zzjq paramzzjq, String paramString, UsageInfo[] paramArrayOfUsageInfo)
        throws RemoteException
      {
        // Byte code:
        //   0: invokestatic 30	android/os/Parcel:obtain	()Landroid/os/Parcel;
        ...
        //   47: aload_0
        //   48: getfield 18	com/google/android/gms/internal/zzjp$zza$zza:zznJ	Landroid/os/IBinder;
        //   51: iconst_1
        //   52: aload 4
        //   54: aload 5
        //   56: iconst_0
      ...
      /* Error */
      public void zza(zzjq paramzzjq, boolean paramBoolean)
        throws RemoteException
      {
        // Byte code:
        //   0: iconst_0
        ...
        //   48: aload_0
        //   49: getfield 18	com/google/android/gms/internal/zzjp$zza$zza:zznJ	Landroid/os/IBinder;
        //   52: iconst_4
        //   53: aload 4
        //   55: aload 5
        //   57: iconst_0
      ...
      /* Error */
      public void zzb(zzjq paramzzjq)
        throws RemoteException
      {
        // Byte code:
        //   0: invokestatic 30	android/os/Parcel:obtain	()Landroid/os/Parcel;
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\internal\zzjp.class
