  ...
  implements Parcelable.Creator<PlusSession>
{
  static void zza(PlusSession paramPlusSession, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 2, paramPlusSession.zzBC(), false);
    zzb.zza(paramParcel, 3, paramPlusSession.zzBD(), false);
    zzb.zza(paramParcel, 4, paramPlusSession.zzBE(), false);
    zzb.zza(paramParcel, 5, paramPlusSession.zzBF(), false);
    zzb.zza(paramParcel, 6, paramPlusSession.zzBG(), false);
    zzb.zza(paramParcel, 7, paramPlusSession.zzmH(), false);
    zzb.zza(paramParcel, 8, paramPlusSession.zzBH(), false);
    zzb.zza(paramParcel, 9, paramPlusSession.zzBI(), paramInt, false);
    zzb.zzI(paramParcel, i);
  }
  
  public PlusSession zzgl(Parcel paramParcel)
  {
  ...
  public PlusSession[] zziY(int paramInt)
  {
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\plus\internal\zzh.class
