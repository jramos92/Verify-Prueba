  ...
  implements Parcelable.Creator<ItemScopeEntity>
{
  static void zza(ItemScopeEntity paramItemScopeEntity, Parcel paramParcel, int paramInt)
  {
    ...
    Set localSet = paramItemScopeEntity.zzaST;
    if (localSet.contains(Integer.valueOf(1))) {
      zzb.zzc(paramParcel, 1, paramItemScopeEntity.mVersionCode);
    }
    if (localSet.contains(Integer.valueOf(2))) {
      zzb.zza(paramParcel, 2, paramItemScopeEntity.zzaSU, paramInt, true);
    }
    if (localSet.contains(Integer.valueOf(3))) {
      zzb.zzb(paramParcel, 3, paramItemScopeEntity.zzaSV, true);
    }
    if (localSet.contains(Integer.valueOf(4))) {
      zzb.zza(paramParcel, 4, paramItemScopeEntity.zzaSW, paramInt, true);
    }
    if (localSet.contains(Integer.valueOf(5))) {
      zzb.zza(paramParcel, 5, paramItemScopeEntity.zzaSX, true);
    }
    if (localSet.contains(Integer.valueOf(6))) {
      zzb.zza(paramParcel, 6, paramItemScopeEntity.zzaSY, true);
    }
    if (localSet.contains(Integer.valueOf(7))) {
      zzb.zza(paramParcel, 7, paramItemScopeEntity.zzaSZ, true);
    }
    if (localSet.contains(Integer.valueOf(8))) {
      zzb.zzc(paramParcel, 8, paramItemScopeEntity.zzaTa, true);
    }
    if (localSet.contains(Integer.valueOf(9))) {
      zzb.zzc(paramParcel, 9, paramItemScopeEntity.zzaTb);
    }
    if (localSet.contains(Integer.valueOf(10))) {
      zzb.zzc(paramParcel, 10, paramItemScopeEntity.zzaTc, true);
    }
    if (localSet.contains(Integer.valueOf(11))) {
      zzb.zza(paramParcel, 11, paramItemScopeEntity.zzaTd, paramInt, true);
    }
    if (localSet.contains(Integer.valueOf(12))) {
      zzb.zzc(paramParcel, 12, paramItemScopeEntity.zzaTe, true);
    }
    if (localSet.contains(Integer.valueOf(13))) {
      zzb.zza(paramParcel, 13, paramItemScopeEntity.zzaTf, true);
    }
    if (localSet.contains(Integer.valueOf(14))) {
      zzb.zza(paramParcel, 14, paramItemScopeEntity.zzaTg, true);
    }
    if (localSet.contains(Integer.valueOf(15))) {
      zzb.zza(paramParcel, 15, paramItemScopeEntity.zzaTh, paramInt, true);
    }
    if (localSet.contains(Integer.valueOf(17))) {
      zzb.zza(paramParcel, 17, paramItemScopeEntity.zzaTj, true);
    }
    if (localSet.contains(Integer.valueOf(16))) {
      zzb.zza(paramParcel, 16, paramItemScopeEntity.zzaTi, true);
    }
    if (localSet.contains(Integer.valueOf(19))) {
      zzb.zzc(paramParcel, 19, paramItemScopeEntity.zzaTk, true);
    }
    if (localSet.contains(Integer.valueOf(18))) {
      zzb.zza(paramParcel, 18, paramItemScopeEntity.zzsX, true);
    }
    if (localSet.contains(Integer.valueOf(21))) {
      zzb.zza(paramParcel, 21, paramItemScopeEntity.zzaTm, true);
    }
    if (localSet.contains(Integer.valueOf(20))) {
      zzb.zza(paramParcel, 20, paramItemScopeEntity.zzaTl, true);
    }
    if (localSet.contains(Integer.valueOf(23))) {
      zzb.zza(paramParcel, 23, paramItemScopeEntity.zzaqZ, true);
    }
    if (localSet.contains(Integer.valueOf(22))) {
      zzb.zza(paramParcel, 22, paramItemScopeEntity.zzaTn, true);
    }
    if (localSet.contains(Integer.valueOf(25))) {
      zzb.zza(paramParcel, 25, paramItemScopeEntity.zzaTp, true);
    }
    if (localSet.contains(Integer.valueOf(24))) {
      zzb.zza(paramParcel, 24, paramItemScopeEntity.zzaTo, true);
    }
    if (localSet.contains(Integer.valueOf(27))) {
      zzb.zza(paramParcel, 27, paramItemScopeEntity.zzaTr, true);
    }
    if (localSet.contains(Integer.valueOf(26))) {
      zzb.zza(paramParcel, 26, paramItemScopeEntity.zzaTq, true);
    }
    if (localSet.contains(Integer.valueOf(29))) {
      zzb.zza(paramParcel, 29, paramItemScopeEntity.zzaTt, paramInt, true);
    }
    if (localSet.contains(Integer.valueOf(28))) {
      zzb.zza(paramParcel, 28, paramItemScopeEntity.zzaTs, true);
    }
    if (localSet.contains(Integer.valueOf(31))) {
      zzb.zza(paramParcel, 31, paramItemScopeEntity.zzaTv, true);
    }
    if (localSet.contains(Integer.valueOf(30))) {
      zzb.zza(paramParcel, 30, paramItemScopeEntity.zzaTu, true);
    }
    if (localSet.contains(Integer.valueOf(34))) {
      zzb.zza(paramParcel, 34, paramItemScopeEntity.zzaTx, paramInt, true);
    }
    if (localSet.contains(Integer.valueOf(32))) {
      zzb.zza(paramParcel, 32, paramItemScopeEntity.zzwN, true);
    }
    if (localSet.contains(Integer.valueOf(33))) {
      zzb.zza(paramParcel, 33, paramItemScopeEntity.zzaTw, true);
    }
    if (localSet.contains(Integer.valueOf(38))) {
      zzb.zza(paramParcel, 38, paramItemScopeEntity.zzaEm);
    }
    ...
    if (localSet.contains(Integer.valueOf(36))) {
      zzb.zza(paramParcel, 36, paramItemScopeEntity.zzaEl);
    }
    if (localSet.contains(Integer.valueOf(37))) {
      zzb.zza(paramParcel, 37, paramItemScopeEntity.zzaTy, paramInt, true);
    }
    if (localSet.contains(Integer.valueOf(42))) {
      zzb.zza(paramParcel, 42, paramItemScopeEntity.zzaTB, true);
    }
    if (localSet.contains(Integer.valueOf(43))) {
      zzb.zza(paramParcel, 43, paramItemScopeEntity.zzaTC, true);
    }
    if (localSet.contains(Integer.valueOf(40))) {
      zzb.zza(paramParcel, 40, paramItemScopeEntity.zzaTz, paramInt, true);
    }
    if (localSet.contains(Integer.valueOf(41))) {
      zzb.zzc(paramParcel, 41, paramItemScopeEntity.zzaTA, true);
    }
    if (localSet.contains(Integer.valueOf(46))) {
      zzb.zza(paramParcel, 46, paramItemScopeEntity.zzaTF, paramInt, true);
    }
    if (localSet.contains(Integer.valueOf(47))) {
      zzb.zza(paramParcel, 47, paramItemScopeEntity.zzaTG, true);
    }
    if (localSet.contains(Integer.valueOf(44))) {
      zzb.zza(paramParcel, 44, paramItemScopeEntity.zzaTD, true);
    }
    if (localSet.contains(Integer.valueOf(45))) {
      zzb.zza(paramParcel, 45, paramItemScopeEntity.zzaTE, true);
    }
    if (localSet.contains(Integer.valueOf(51))) {
      zzb.zza(paramParcel, 51, paramItemScopeEntity.zzaTK, true);
    }
    if (localSet.contains(Integer.valueOf(50))) {
      zzb.zza(paramParcel, 50, paramItemScopeEntity.zzaTJ, paramInt, true);
    }
    if (localSet.contains(Integer.valueOf(49))) {
      zzb.zza(paramParcel, 49, paramItemScopeEntity.zzaTI, true);
    }
    if (localSet.contains(Integer.valueOf(48))) {
      zzb.zza(paramParcel, 48, paramItemScopeEntity.zzaTH, true);
    }
    if (localSet.contains(Integer.valueOf(55))) {
      zzb.zza(paramParcel, 55, paramItemScopeEntity.zzaTM, true);
    }
    ...
    if (localSet.contains(Integer.valueOf(53))) {
      zzb.zza(paramParcel, 53, paramItemScopeEntity.zzGq, true);
    }
    if (localSet.contains(Integer.valueOf(52))) {
      zzb.zza(paramParcel, 52, paramItemScopeEntity.zzaTL, true);
    }
    if (localSet.contains(Integer.valueOf(56))) {
      zzb.zza(paramParcel, 56, paramItemScopeEntity.zzaTN, true);
    }
    zzb.zzI(paramParcel, i);
  }
  
  public ItemScopeEntity zzgm(Parcel paramParcel)
  {
  ...
  public ItemScopeEntity[] zziZ(int paramInt)
  {
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\plus\internal\model\moments\zza.class
