  ...
  implements Parcelable.Creator<PersonEntity>
{
  static void zza(PersonEntity paramPersonEntity, Parcel paramParcel, int paramInt)
  {
    ...
    Set localSet = paramPersonEntity.zzaST;
    if (localSet.contains(Integer.valueOf(1))) {
      zzb.zzc(paramParcel, 1, paramPersonEntity.mVersionCode);
    }
    if (localSet.contains(Integer.valueOf(2))) {
      zzb.zza(paramParcel, 2, paramPersonEntity.zzaTR, true);
    }
    if (localSet.contains(Integer.valueOf(3))) {
      zzb.zza(paramParcel, 3, paramPersonEntity.zzaTS, paramInt, true);
    }
    if (localSet.contains(Integer.valueOf(4))) {
      zzb.zza(paramParcel, 4, paramPersonEntity.zzaTT, true);
    }
    if (localSet.contains(Integer.valueOf(5))) {
      zzb.zza(paramParcel, 5, paramPersonEntity.zzaTU, true);
    }
    if (localSet.contains(Integer.valueOf(6))) {
      zzb.zzc(paramParcel, 6, paramPersonEntity.zzaTV);
    }
    if (localSet.contains(Integer.valueOf(7))) {
      zzb.zza(paramParcel, 7, paramPersonEntity.zzaTW, paramInt, true);
    }
    if (localSet.contains(Integer.valueOf(8))) {
      zzb.zza(paramParcel, 8, paramPersonEntity.zzaTX, true);
    }
    if (localSet.contains(Integer.valueOf(9))) {
      zzb.zza(paramParcel, 9, paramPersonEntity.zzTa, true);
    }
    if (localSet.contains(Integer.valueOf(12))) {
      zzb.zzc(paramParcel, 12, paramPersonEntity.zzsR);
    }
    if (localSet.contains(Integer.valueOf(14))) {
      zzb.zza(paramParcel, 14, paramPersonEntity.zzwN, true);
    }
    if (localSet.contains(Integer.valueOf(15))) {
      zzb.zza(paramParcel, 15, paramPersonEntity.zzaTY, paramInt, true);
    }
    if (localSet.contains(Integer.valueOf(16))) {
      zzb.zza(paramParcel, 16, paramPersonEntity.zzaTZ);
    }
    if (localSet.contains(Integer.valueOf(19))) {
      zzb.zza(paramParcel, 19, paramPersonEntity.zzaUa, paramInt, true);
    }
    if (localSet.contains(Integer.valueOf(18))) {
      zzb.zza(paramParcel, 18, paramPersonEntity.zzVT, true);
    }
    if (localSet.contains(Integer.valueOf(21))) {
      zzb.zzc(paramParcel, 21, paramPersonEntity.zzaUc);
    }
    if (localSet.contains(Integer.valueOf(20))) {
      zzb.zza(paramParcel, 20, paramPersonEntity.zzaUb, true);
    }
    if (localSet.contains(Integer.valueOf(23))) {
      zzb.zzc(paramParcel, 23, paramPersonEntity.zzaUe, true);
    }
    if (localSet.contains(Integer.valueOf(22))) {
      zzb.zzc(paramParcel, 22, paramPersonEntity.zzaUd, true);
    }
    if (localSet.contains(Integer.valueOf(25))) {
      zzb.zzc(paramParcel, 25, paramPersonEntity.zzaUg);
    }
    if (localSet.contains(Integer.valueOf(24))) {
      zzb.zzc(paramParcel, 24, paramPersonEntity.zzaUf);
    }
    ...
    if (localSet.contains(Integer.valueOf(26))) {
      zzb.zza(paramParcel, 26, paramPersonEntity.zzaUh, true);
    }
    if (localSet.contains(Integer.valueOf(29))) {
      zzb.zza(paramParcel, 29, paramPersonEntity.zzaUj);
    }
    if (localSet.contains(Integer.valueOf(28))) {
      zzb.zzc(paramParcel, 28, paramPersonEntity.zzaUi, true);
    }
    zzb.zzI(paramParcel, i);
  }
  
  public PersonEntity zzgo(Parcel paramParcel)
  {
    int i2 = com.google.android.gms.common.internal.safeparcel.zza.zzap(paramParcel);
    ...
    {
      int i3 = com.google.android.gms.common.internal.safeparcel.zza.zzao(paramParcel);
      switch (com.google.android.gms.common.internal.safeparcel.zza.zzbM(i3))
      {
      case 10: 
      case 11: 
      case 13: 
  ...
  public PersonEntity[] zzjb(int paramInt)
  {
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\plus\internal\model\people\zza.class
