...
public final class PlusShare
{
  ...
  protected static boolean zzen(String paramString)
  {
  ...
  public static class Builder
  {
    ...
    {
      zzx.zza(this.zzaSm, "Must include the launching activity with PlusShare.Builder constructor before setting call-to-action");
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        if (!TextUtils.isEmpty(paramString2))
        {
          zzx.zza(PlusShare.zzen(paramString2), "The specified deep-link ID was malformed.");
    ...
    public Builder addStream(Uri paramUri)
    {
      ...
      this.zzaSn.add(localUri);
      this.zzaSn.add(paramUri);
      return this;
    }
    ...
    public Intent getIntent()
    {
      ...
      int i;
      boolean bool1;
      if ((this.zzaSn != null) && (this.zzaSn.size() > 1))
      {
        i = 1;
        ...
        if (this.mIntent.hasExtra("com.google.android.apps.plus.CONTENT_DEEP_LINK_ID")) {
          zzx.zza(PlusShare.zzen(this.mIntent.getStringExtra("com.google.android.apps.plus.CONTENT_DEEP_LINK_ID")), "The specified deep-link ID was malformed.");
        }
        if ((i == 0) && (bool3))
        {
          this.mIntent.setAction("android.intent.action.SEND");
          if ((this.zzaSn == null) || (this.zzaSn.isEmpty())) {
            break label322;
          }
          this.mIntent.putExtra("android.intent.extra.STREAM", (Parcelable)this.zzaSn.get(0));
          label217:
          this.zzaSn = null;
        }
        if ((i != 0) && (!bool3))
        {
          ...
          this.mIntent.putParcelableArrayListExtra("android.intent.extra.STREAM", this.zzaSn);
        }
      }
      for (;;)
      {
    ...
    {
      zzx.zzb(this.zzaSm, "Must include the launching activity with PlusShare.Builder constructor before setting deep links");
      if (!TextUtils.isEmpty(paramString1)) {}
      for (boolean bool = true;; bool = false)
      {
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\plus\PlusShare.class
