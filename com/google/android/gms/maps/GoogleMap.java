...
public final class GoogleMap
{
  ...
  {
    this.zzaIh = ((IGoogleMapDelegate)zzx.zzw(paramIGoogleMapDelegate));
  }
  ...
  public final Circle addCircle(CircleOptions paramCircleOptions)
  {
    try
    {
      paramCircleOptions = new Circle(this.zzaIh.addCircle(paramCircleOptions));
  ...
  public final GroundOverlay addGroundOverlay(GroundOverlayOptions paramGroundOverlayOptions)
  {
    try
    {
      paramGroundOverlayOptions = this.zzaIh.addGroundOverlay(paramGroundOverlayOptions);
  ...
  public final Marker addMarker(MarkerOptions paramMarkerOptions)
  {
    try
    {
      paramMarkerOptions = this.zzaIh.addMarker(paramMarkerOptions);
  ...
  public final Polygon addPolygon(PolygonOptions paramPolygonOptions)
  {
    try
    {
      paramPolygonOptions = new Polygon(this.zzaIh.addPolygon(paramPolygonOptions));
  ...
  public final Polyline addPolyline(PolylineOptions paramPolylineOptions)
  {
    try
    {
      paramPolylineOptions = new Polyline(this.zzaIh.addPolyline(paramPolylineOptions));
  ...
  public final TileOverlay addTileOverlay(TileOverlayOptions paramTileOverlayOptions)
  {
    try
    {
      paramTileOverlayOptions = this.zzaIh.addTileOverlay(paramTileOverlayOptions);
  ...
  public final void animateCamera(CameraUpdate paramCameraUpdate)
  {
    try
    {
      this.zzaIh.animateCamera(paramCameraUpdate.zzxw());
      return;
    }
  ...
  public final void animateCamera(CameraUpdate paramCameraUpdate, int paramInt, CancelableCallback paramCancelableCallback)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 104	com/google/android/gms/maps/GoogleMap:zzaIh	Lcom/google/android/gms/maps/internal/IGoogleMapDelegate;
    //   4: astore 4
    //   6: aload_1
    //   7: invokevirtual 180	com/google/android/gms/maps/CameraUpdate:zzxw	()Lcom/google/android/gms/dynamic/zzd;
    //   10: astore 5
    //   12: aload_3
    //   13: ifnonnull +17 -> 30
    //   16: aconst_null
  ...
  public final void animateCamera(CameraUpdate paramCameraUpdate, CancelableCallback paramCancelableCallback)
  {
    ...
    //   4: astore_3
    //   5: aload_1
    //   6: invokevirtual 180	com/google/android/gms/maps/CameraUpdate:zzxw	()Lcom/google/android/gms/dynamic/zzd;
    //   9: astore 4
    //   11: aload_2
    //   12: ifnonnull +15 -> 27
    //   15: aconst_null
  ...
  public final CameraPosition getCameraPosition()
  {
    try
    {
      CameraPosition localCameraPosition = this.zzaIh.getCameraPosition();
  ...
  public IndoorBuilding getFocusedBuilding()
  {
    try
    {
      Object localObject = this.zzaIh.getFocusedBuilding();
      if (localObject != null)
      {
  ...
  public final float getMaxZoomLevel()
  {
    try
    {
      float f = this.zzaIh.getMaxZoomLevel();
      return f;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final float getMinZoomLevel()
  {
    try
    {
      float f = this.zzaIh.getMinZoomLevel();
      return f;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final Location getMyLocation()
  {
    try
    {
      Location localLocation = this.zzaIh.getMyLocation();
  ...
  public final Projection getProjection()
  {
    try
    {
      Projection localProjection = new Projection(this.zzaIh.getProjection());
  ...
  public final UiSettings getUiSettings()
  {
    try
    {
      ...
      UiSettings localUiSettings = this.zzaIi;
  ...
  public final boolean isBuildingsEnabled()
  {
    try
    {
      boolean bool = this.zzaIh.isBuildingsEnabled();
      return bool;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final boolean isIndoorEnabled()
  {
    try
    {
      boolean bool = this.zzaIh.isIndoorEnabled();
      return bool;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final boolean isMyLocationEnabled()
  {
    try
    {
      boolean bool = this.zzaIh.isMyLocationEnabled();
      return bool;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final boolean isTrafficEnabled()
  {
    try
    {
      boolean bool = this.zzaIh.isTrafficEnabled();
      return bool;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final void moveCamera(CameraUpdate paramCameraUpdate)
  {
    try
    {
      this.zzaIh.moveCamera(paramCameraUpdate.zzxw());
      return;
    }
    catch (RemoteException paramCameraUpdate)
    {
  ...
  public final void setBuildingsEnabled(boolean paramBoolean)
  {
    try
    {
      this.zzaIh.setBuildingsEnabled(paramBoolean);
      return;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final void setContentDescription(String paramString)
  {
    try
    {
      this.zzaIh.setContentDescription(paramString);
      return;
    }
  ...
  public final boolean setIndoorEnabled(boolean paramBoolean)
  {
    try
    {
      paramBoolean = this.zzaIh.setIndoorEnabled(paramBoolean);
      return paramBoolean;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final void setInfoWindowAdapter(final InfoWindowAdapter paramInfoWindowAdapter)
  {
    ...
    this.zzaIh.setInfoWindowAdapter(new zzd.zza()
    {
      public com.google.android.gms.dynamic.zzd zzf(zzf paramAnonymouszzf)
      {
        return zze.zzy(paramInfoWindowAdapter.getInfoWindow(new Marker(paramAnonymouszzf)));
      }
      
      public com.google.android.gms.dynamic.zzd zzg(zzf paramAnonymouszzf)
      {
        return zze.zzy(paramInfoWindowAdapter.getInfoContents(new Marker(paramAnonymouszzf)));
      }
    });
  }
  ...
  public final void setLocationSource(final LocationSource paramLocationSource)
  {
    ...
    this.zzaIh.setLocationSource(new ILocationSourceDelegate.zza()
    {
  ...
  public final void setMapType(int paramInt)
  {
    try
    {
      this.zzaIh.setMapType(paramInt);
      return;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final void setMyLocationEnabled(boolean paramBoolean)
  {
    try
    {
      this.zzaIh.setMyLocationEnabled(paramBoolean);
      return;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final void setOnCameraChangeListener(final OnCameraChangeListener paramOnCameraChangeListener)
  {
    ...
    this.zzaIh.setOnCameraChangeListener(new zze.zza()
    {
  ...
  public final void setOnIndoorStateChangeListener(final OnIndoorStateChangeListener paramOnIndoorStateChangeListener)
  {
    ...
    this.zzaIh.setOnIndoorStateChangeListener(new zzf.zza()
    {
  ...
  public final void setOnInfoWindowClickListener(final OnInfoWindowClickListener paramOnInfoWindowClickListener)
  {
    ...
    this.zzaIh.setOnInfoWindowClickListener(new zzg.zza()
    {
  ...
  public final void setOnMapClickListener(final OnMapClickListener paramOnMapClickListener)
  {
    ...
    this.zzaIh.setOnMapClickListener(new zzi.zza()
    {
  ...
  public void setOnMapLoadedCallback(final OnMapLoadedCallback paramOnMapLoadedCallback)
  {
    ...
    this.zzaIh.setOnMapLoadedCallback(new zzj.zza()
    {
  ...
  public final void setOnMapLongClickListener(final OnMapLongClickListener paramOnMapLongClickListener)
  {
    ...
    this.zzaIh.setOnMapLongClickListener(new zzk.zza()
    {
  ...
  public final void setOnMarkerClickListener(final OnMarkerClickListener paramOnMarkerClickListener)
  {
    ...
    this.zzaIh.setOnMarkerClickListener(new zzm.zza()
    {
  ...
  public final void setOnMarkerDragListener(final OnMarkerDragListener paramOnMarkerDragListener)
  {
    ...
    this.zzaIh.setOnMarkerDragListener(new zzn.zza()
    {
  ...
  public final void setOnMyLocationButtonClickListener(final OnMyLocationButtonClickListener paramOnMyLocationButtonClickListener)
  {
    ...
    this.zzaIh.setOnMyLocationButtonClickListener(new zzo.zza()
    {
  ...
  public final void setOnMyLocationChangeListener(final OnMyLocationChangeListener paramOnMyLocationChangeListener)
  {
    ...
    this.zzaIh.setOnMyLocationChangeListener(new zzp.zza()
    {
  ...
  public final void setPadding(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    try
    {
      this.zzaIh.setPadding(paramInt1, paramInt2, paramInt3, paramInt4);
      return;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final void setTrafficEnabled(boolean paramBoolean)
  {
    try
    {
      this.zzaIh.setTrafficEnabled(paramBoolean);
      return;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  {
    if (paramBitmap != null) {}
    for (paramBitmap = zze.zzy(paramBitmap);; paramBitmap = null)
    {
      paramBitmap = (zze)paramBitmap;
      try
      {
        this.zzaIh.snapshot(new zzw.zza()
        {
  ...
  private static final class zza
    extends zzb.zza
  {
    private final GoogleMap.CancelableCallback zzaIz;
    
    zza(GoogleMap.CancelableCallback paramCancelableCallback)
    {
      this.zzaIz = paramCancelableCallback;
    }
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\maps\GoogleMap.class
