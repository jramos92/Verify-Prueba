  ...
  implements Parcelable.Creator<PointOfInterest>
{
  static void zza(PointOfInterest paramPointOfInterest, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 2, paramPointOfInterest.zzaKr, paramInt, false);
    zzb.zza(paramParcel, 3, paramPointOfInterest.zzaKs, false);
    zzb.zza(paramParcel, 4, paramPointOfInterest.name, false);
    zzb.zzI(paramParcel, i);
  }
  
  public PointOfInterest zzfn(Parcel paramParcel)
  {
    String str = null;
  ...
  public PointOfInterest[] zzhL(int paramInt)
  {
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\maps\model\zzg.class
