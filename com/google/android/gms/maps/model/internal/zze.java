  ...
  extends IInterface
{
    ...
    implements zze
  {
      ...
      throws RemoteException
    {
      ...
      case 4: 
        paramParcel1.enforceInterface("com.google.android.gms.maps.model.internal.IIndoorLevelDelegate");
        boolean bool = zza(zzcT(paramParcel1.readStrongBinder()));
        paramParcel2.writeNoException();
        if (bool) {}
      ...
      implements zze
    {
        ...
        throws RemoteException
      {
        ...
        //   36: aload_0
        //   37: getfield 18	com/google/android/gms/maps/model/internal/zze$zza$zza:zznJ	Landroid/os/IBinder;
        //   40: iconst_4
        //   41: aload 4
        //   43: aload 5
        //   45: iconst_0
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\maps\model\internal\zze.class
