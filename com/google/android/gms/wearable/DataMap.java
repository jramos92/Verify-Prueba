...
public class DataMap
{
  ...
  private final HashMap<String, Object> zzbfa = new HashMap();
  ...
  public static DataMap fromByteArray(byte[] paramArrayOfByte)
  {
    try
    {
      paramArrayOfByte = zzrs.zza(new zzrs.zza(zzrt.zzy(paramArrayOfByte), new ArrayList()));
  ...
  {
    return this.zzbfa.containsKey(paramString);
  }
  ...
  {
    return (T)this.zzbfa.get(paramString);
  }
  
  public Asset getAsset(String paramString)
  {
    Object localObject = this.zzbfa.get(paramString);
    if (localObject == null) {
      return null;
    }
    try
  ...
  public int hashCode()
  {
    return this.zzbfa.hashCode() * 29;
  }
  
  public boolean isEmpty()
  {
    return this.zzbfa.isEmpty();
  }
  
  public Set<String> keySet()
  {
    return this.zzbfa.keySet();
  }
  ...
  public void putAll(DataMap paramDataMap)
  {
    ...
    {
      String str = (String)localIterator.next();
      this.zzbfa.put(str, paramDataMap.get(str));
    }
  }
  
  public void putAsset(String paramString, Asset paramAsset)
  {
    this.zzbfa.put(paramString, paramAsset);
  }
  
  public void putBoolean(String paramString, boolean paramBoolean)
  {
    this.zzbfa.put(paramString, Boolean.valueOf(paramBoolean));
  }
  
  public void putByte(String paramString, byte paramByte)
  {
    this.zzbfa.put(paramString, Byte.valueOf(paramByte));
  }
  
  public void putByteArray(String paramString, byte[] paramArrayOfByte)
  {
    this.zzbfa.put(paramString, paramArrayOfByte);
  }
  
  public void putDataMap(String paramString, DataMap paramDataMap)
  {
    this.zzbfa.put(paramString, paramDataMap);
  }
  
  public void putDataMapArrayList(String paramString, ArrayList<DataMap> paramArrayList)
  {
    this.zzbfa.put(paramString, paramArrayList);
  }
  
  public void putDouble(String paramString, double paramDouble)
  {
    this.zzbfa.put(paramString, Double.valueOf(paramDouble));
  }
  
  public void putFloat(String paramString, float paramFloat)
  {
    this.zzbfa.put(paramString, Float.valueOf(paramFloat));
  }
  
  public void putFloatArray(String paramString, float[] paramArrayOfFloat)
  {
    this.zzbfa.put(paramString, paramArrayOfFloat);
  }
  
  public void putInt(String paramString, int paramInt)
  {
    this.zzbfa.put(paramString, Integer.valueOf(paramInt));
  }
  ...
  {
    this.zzbfa.put(paramString, Long.valueOf(paramLong));
  }
  
  public void putLongArray(String paramString, long[] paramArrayOfLong)
  {
    this.zzbfa.put(paramString, paramArrayOfLong);
  }
  
  public void putString(String paramString1, String paramString2)
  {
    this.zzbfa.put(paramString1, paramString2);
  }
  
  public void putStringArray(String paramString, String[] paramArrayOfString)
  {
    this.zzbfa.put(paramString, paramArrayOfString);
  }
  ...
  {
    return this.zzbfa.remove(paramString);
  }
  
  public int size()
  {
    return this.zzbfa.size();
  }
  
  public Bundle toBundle()
  {
    Bundle localBundle = new Bundle();
    Iterator localIterator = this.zzbfa.keySet().iterator();
    while (localIterator.hasNext())
    {
      String str = (String)localIterator.next();
      zzb(localBundle, str, this.zzbfa.get(str));
    }
    return localBundle;
  }
  ...
  {
    return zzse.zzf(zzrs.zza(this).zzbhz);
  }
  
  public String toString()
  {
    return this.zzbfa.toString();
  }
}


/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\wearable\DataMap.class
