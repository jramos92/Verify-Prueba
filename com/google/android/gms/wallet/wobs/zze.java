  ...
  implements Parcelable.Creator<LoyaltyPoints>
{
  static void zza(LoyaltyPoints paramLoyaltyPoints, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 3, paramLoyaltyPoints.zzbeG, paramInt, false);
    zzb.zza(paramParcel, 4, paramLoyaltyPoints.type, false);
    zzb.zza(paramParcel, 5, paramLoyaltyPoints.zzbcY, paramInt, false);
    zzb.zzI(paramParcel, i);
  }
  
  public LoyaltyPoints zzhz(Parcel paramParcel)
  {
  ...
  public LoyaltyPoints[] zzkF(int paramInt)
  {
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\wallet\wobs\zze.class
