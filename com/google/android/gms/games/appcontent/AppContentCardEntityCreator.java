  ...
  implements Parcelable.Creator<AppContentCardEntity>
{
  static void zza(AppContentCardEntity paramAppContentCardEntity, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zzc(paramParcel, 2, paramAppContentCardEntity.zzua(), false);
    zzb.zzc(paramParcel, 3, paramAppContentCardEntity.zztP(), false);
    zzb.zza(paramParcel, 4, paramAppContentCardEntity.zztQ(), false);
    zzb.zzc(paramParcel, 5, paramAppContentCardEntity.zzub());
    ...
    zzb.zza(paramParcel, 10, paramAppContentCardEntity.zzuc(), false);
    zzb.zza(paramParcel, 11, paramAppContentCardEntity.getTitle(), false);
    zzb.zzc(paramParcel, 12, paramAppContentCardEntity.zzud());
  ...
  public AppContentCardEntity zzdU(Parcel paramParcel)
  {
  ...
  public AppContentCardEntity[] zzfN(int paramInt)
  {
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\games\appcontent\AppContentCardEntityCreator.class
