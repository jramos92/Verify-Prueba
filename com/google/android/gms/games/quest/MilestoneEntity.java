  ...
  implements SafeParcelable, Milestone
{
  ...
  MilestoneEntity(int paramInt1, String paramString1, long paramLong1, long paramLong2, byte[] paramArrayOfByte, int paramInt2, String paramString2)
  {
    ...
    this.zzawj = paramString1;
    this.zzaBn = paramLong1;
    this.zzaBo = paramLong2;
    this.zzaBp = paramArrayOfByte;
  ...
  {
    this.mVersionCode = 4;
    this.zzawj = paramMilestone.getMilestoneId();
    this.zzaBn = paramMilestone.getCurrentProgress();
    this.zzaBo = paramMilestone.getTargetProgress();
    this.mState = paramMilestone.getState();
    this.zzavb = paramMilestone.getEventId();
    ...
    this.zzaBp = new byte[paramMilestone.length];
    System.arraycopy(paramMilestone, 0, this.zzaBp, 0, paramMilestone.length);
  }
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\games\quest\MilestoneEntity.class
