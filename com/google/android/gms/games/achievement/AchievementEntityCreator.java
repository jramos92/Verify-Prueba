  ...
  implements Parcelable.Creator<AchievementEntity>
{
  static void zza(AchievementEntity paramAchievementEntity, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zzc(paramParcel, 9, paramAchievementEntity.zztK());
    zzb.zza(paramParcel, 10, paramAchievementEntity.zztL(), false);
    ...
    zzb.zzc(paramParcel, 13, paramAchievementEntity.zztM());
    zzb.zza(paramParcel, 14, paramAchievementEntity.zztN(), false);
  ...
  public AchievementEntity zzdR(Parcel paramParcel)
  {
  ...
  public AchievementEntity[] zzfK(int paramInt)
  {
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\games\achievement\AchievementEntityCreator.class
