  ...
  implements Leaderboards
{
  ...
  {
    return Games.zzc(paramGoogleApiClient).zzuB();
  }
  ...
  {
    return Games.zzc(paramGoogleApiClient).zzl(paramString, paramInt1, paramInt2);
  }
  ...
  public PendingResult<Leaderboards.SubmitScoreResult> submitScoreImmediate(GoogleApiClient paramGoogleApiClient, final String paramString1, final long paramLong, String paramString2)
  {
    paramGoogleApiClient.zzb(new SubmitScoreImpl(paramGoogleApiClient)
    {
      protected void zza(GamesClientImpl paramAnonymousGamesClientImpl)
        throws RemoteException
      {
        paramAnonymousGamesClientImpl.zza(this, paramString1, paramLong, this.zzaxA);
      }
    });
  }
    ...
    extends Games.BaseGamesApiMethodImpl<Leaderboards.LeaderboardMetadataResult>
  {
    ...
    public Leaderboards.LeaderboardMetadataResult zzag(final Status paramStatus)
    {
    ...
    extends Games.BaseGamesApiMethodImpl<Leaderboards.LoadPlayerScoreResult>
  {
    ...
    public Leaderboards.LoadPlayerScoreResult zzah(final Status paramStatus)
    {
    ...
    extends Games.BaseGamesApiMethodImpl<Leaderboards.LoadScoresResult>
  {
    ...
    public Leaderboards.LoadScoresResult zzai(final Status paramStatus)
    {
    ...
    extends Games.BaseGamesApiMethodImpl<Leaderboards.SubmitScoreResult>
  {
    ...
    public Leaderboards.SubmitScoreResult zzaj(final Status paramStatus)
    {
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\games\internal\api\LeaderboardsImpl.class
