  ...
  implements Quests
{
  ...
  {
    return Games.zzc(paramGoogleApiClient).zzcX(paramString);
  }
  
  public Intent getQuestsIntent(GoogleApiClient paramGoogleApiClient, int[] paramArrayOfInt)
  {
    return Games.zzc(paramGoogleApiClient).zzb(paramArrayOfInt);
  }
  ...
  public void showStateChangedPopup(GoogleApiClient paramGoogleApiClient, String paramString)
  {
    ...
    if (paramGoogleApiClient != null) {
      paramGoogleApiClient.zzcY(paramString);
    }
  }
    ...
    extends Games.BaseGamesApiMethodImpl<Quests.AcceptQuestResult>
  {
    ...
    public Quests.AcceptQuestResult zzas(final Status paramStatus)
    {
    ...
    extends Games.BaseGamesApiMethodImpl<Quests.ClaimMilestoneResult>
  {
    ...
    public Quests.ClaimMilestoneResult zzat(final Status paramStatus)
    {
    ...
    extends Games.BaseGamesApiMethodImpl<Quests.LoadQuestsResult>
  {
    ...
    public Quests.LoadQuestsResult zzau(final Status paramStatus)
    {
      new Quests.LoadQuestsResult()
      {
        public QuestBuffer getQuests()
        {
          return new QuestBuffer(DataHolder.zzbu(paramStatus.getStatusCode()));
        }
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\games\internal\api\QuestsImpl.class
