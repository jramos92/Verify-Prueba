  ...
  implements Snapshots
{
  ...
  {
    Games.zzc(paramGoogleApiClient).zza(paramSnapshot);
  }
  
  public int getMaxCoverImageSize(GoogleApiClient paramGoogleApiClient)
  {
    return Games.zzc(paramGoogleApiClient).zzuS();
  }
  
  public int getMaxDataSize(GoogleApiClient paramGoogleApiClient)
  {
    return Games.zzc(paramGoogleApiClient).zzuR();
  }
  ...
  {
    return Games.zzc(paramGoogleApiClient).zza(paramString, paramBoolean1, paramBoolean2, paramInt);
  }
    ...
    extends Games.BaseGamesApiMethodImpl<Snapshots.CommitSnapshotResult>
  {
    ...
    public Snapshots.CommitSnapshotResult zzaz(final Status paramStatus)
    {
    ...
    extends Games.BaseGamesApiMethodImpl<Snapshots.DeleteSnapshotResult>
  {
    ...
    public Snapshots.DeleteSnapshotResult zzaA(final Status paramStatus)
    {
    ...
    extends Games.BaseGamesApiMethodImpl<Snapshots.LoadSnapshotsResult>
  {
    ...
    public Snapshots.LoadSnapshotsResult zzaB(final Status paramStatus)
    {
    ...
    extends Games.BaseGamesApiMethodImpl<Snapshots.OpenSnapshotResult>
  {
    ...
    public Snapshots.OpenSnapshotResult zzaC(final Status paramStatus)
    {
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\games\internal\api\SnapshotsImpl.class
