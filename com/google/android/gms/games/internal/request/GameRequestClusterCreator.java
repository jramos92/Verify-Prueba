  ...
  implements Parcelable.Creator<GameRequestCluster>
{
  static void zza(GameRequestCluster paramGameRequestCluster, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zzc(paramParcel, 1, paramGameRequestCluster.zzvD(), false);
    zzb.zzc(paramParcel, 1000, paramGameRequestCluster.getVersionCode());
    zzb.zzI(paramParcel, paramInt);
  }
  
  public GameRequestCluster zzed(Parcel paramParcel)
  {
  ...
  public GameRequestCluster[] zzgi(int paramInt)
  {
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\games\internal\request\GameRequestClusterCreator.class
