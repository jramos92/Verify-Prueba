  ...
  implements Parcelable.Creator<GameRequestEntity>
{
  static void zza(GameRequestEntity paramGameRequestEntity, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 11, paramGameRequestEntity.zzvR(), false);
    zzb.zzc(paramParcel, 12, paramGameRequestEntity.getStatus());
    zzb.zzI(paramParcel, i);
  }
  
  public GameRequestEntity zzem(Parcel paramParcel)
  {
  ...
  public GameRequestEntity[] zzgs(int paramInt)
  {
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\games\request\GameRequestEntityCreator.class
