  ...
  implements Parcelable.Creator<GameEntity>
{
  static void zza(GameEntity paramGameEntity, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 10, paramGameEntity.zztx());
    zzb.zza(paramParcel, 11, paramGameEntity.zztz());
    zzb.zza(paramParcel, 12, paramGameEntity.zztA(), false);
    zzb.zzc(paramParcel, 13, paramGameEntity.zztB());
    ...
    zzb.zza(paramParcel, 22, paramGameEntity.zzty());
  ...
  public GameEntity[] zzfF(int paramInt)
  {
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\games\GameEntityCreator.class
