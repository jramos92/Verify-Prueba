...
{
  private static final String zzNm = String.format("CREATE TABLE IF NOT EXISTS %s ( '%s' INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, '%s' INTEGER NOT NULL, '%s' TEXT NOT NULL, '%s' TEXT NOT NULL, '%s' INTEGER);", new Object[] { "hits2", "hit_id", "hit_time", "hit_url", "hit_string", "hit_app_id" });
  private static final String zzNn = String.format("SELECT MAX(%s) FROM %s WHERE 1;", new Object[] { "hit_time", "hits2" });
  ...
  zzj(zzf paramzzf)
  {
    super(paramzzf);
    String str = zziZ();
    this.zzNo = new zza(paramzzf.getContext(), str);
  }
  
  private static String zzB(Map<String, String> paramMap)
  {
    com.google.android.gms.common.internal.zzx.zzw(paramMap);
  ...
  {
    com.google.android.gms.common.internal.zzx.zzw(paramzzab);
    Object localObject = new Uri.Builder();
  ...
  SQLiteDatabase getWritableDatabase()
  {
    try
    {
      SQLiteDatabase localSQLiteDatabase = this.zzNo.getWritableDatabase();
  ...
  {
    com.google.android.gms.common.internal.zzx.zzcr(paramString1);
    com.google.android.gms.common.internal.zzx.zzcr(paramString2);
    zziE();
    zzis();
  ...
  {
    com.google.android.gms.common.internal.zzx.zzcr(paramString);
    zziE();
    zzis();
  ...
  {
    com.google.android.gms.common.internal.zzx.zzw(paramzzh);
    zziE();
    zzis();
    SQLiteDatabase localSQLiteDatabase = getWritableDatabase();
    String str = zzB(paramzzh.zzn());
    ContentValues localContentValues = new ContentValues();
    localContentValues.put("app_uid", Long.valueOf(paramzzh.zziM()));
    localContentValues.put("cid", paramzzh.getClientId());
    localContentValues.put("tid", paramzzh.zziN());
    if (paramzzh.zziO()) {}
    for (int i = 1;; i = 0)
    {
      localContentValues.put("adid", Integer.valueOf(i));
      localContentValues.put("hits_count", Long.valueOf(paramzzh.zziP()));
  ...
  public void zzc(zzab paramzzab)
  {
    ...
    localContentValues.put("hit_time", Long.valueOf(paramzzab.zzkA()));
  ...
  public long zziX()
  {
    zzis();
    zziE();
    return zza(zzNn, null, 0L);
  }
  
  public void zzk(List<Long> paramList)
  {
    com.google.android.gms.common.internal.zzx.zzw(paramList);
    zzis();
    zziE();
  ...
  public List<Long> zzo(long paramLong)
  {
    ...
    //   7: aload_0
    //   8: invokevirtual 262	com/google/android/gms/analytics/internal/zzj:zziE	()V
    //   11: lload_1
    //   12: lconst_0
    //   13: lcmp
    //   14: ifgt +7 -> 21
  ...
  public List<zzh> zzr(long paramLong)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 262	com/google/android/gms/analytics/internal/zzj:zziE	()V
    //   4: aload_0
    ...
    //   25: invokevirtual 597	com/google/android/gms/analytics/internal/zzr:zzjZ	()I
    //   28: istore_3
    //   29: aload 8
    //   31: astore 7
    //   33: aload 9
    ...
    extends SQLiteOpenHelper
  {
    ...
    private boolean zza(SQLiteDatabase paramSQLiteDatabase, String paramString)
    {
      ...
      //   67: astore_1
      //   68: aload_0
      //   69: getfield 13	com/google/android/gms/analytics/internal/zzj$zza:zzNr	Lcom/google/android/gms/analytics/internal/zzj;
      //   72: ldc 96
      //   74: aload_2
      //   75: aload 5
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\analytics\internal\zzj.class
