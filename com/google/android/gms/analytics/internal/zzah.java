  ...
  extends zzd
{
  ...
  private final String zzIa = zza("GoogleAnalytics", zze.VERSION, Build.VERSION.RELEASE, zzam.zza(Locale.getDefault()), Build.MODEL, Build.ID);
  private final zzaj zzPx;
  
  zzah(zzf paramzzf)
  {
    super(paramzzf);
    this.zzPx = new zzaj(paramzzf.zzit());
  }
  ...
  private int zza(URL paramURL, byte[] paramArrayOfByte)
  {
    ...
    //   10: astore 7
    //   12: aload_1
    //   13: invokestatic 88	com/google/android/gms/common/internal/zzx:zzw	(Ljava/lang/Object;)Ljava/lang/Object;
    //   16: pop
    //   17: aload_2
    //   18: invokestatic 88	com/google/android/gms/common/internal/zzx:zzw	(Ljava/lang/Object;)Ljava/lang/Object;
    //   21: pop
    //   22: aload_0
    //   23: ldc 90
    //   25: aload_2
    ...
    //   34: aload_0
    //   35: invokevirtual 104	com/google/android/gms/analytics/internal/zzah:zziD	()Z
    //   38: ifeq +17 -> 55
    //   41: aload_0
    //   42: ldc 106
    ...
    //   202: astore 7
    //   204: aload_0
    //   205: invokevirtual 149	com/google/android/gms/analytics/internal/zzah:zzhP	()Lcom/google/android/gms/analytics/internal/zzb;
  ...
  private int zzb(URL paramURL, byte[] paramArrayOfByte)
  {
    ...
    //   4: astore 5
    //   6: aload_1
    //   7: invokestatic 88	com/google/android/gms/common/internal/zzx:zzw	(Ljava/lang/Object;)Ljava/lang/Object;
    //   10: pop
    //   11: aload_2
    //   12: invokestatic 88	com/google/android/gms/common/internal/zzx:zzw	(Ljava/lang/Object;)Ljava/lang/Object;
    //   15: pop
    //   16: aload_2
    ...
    //   75: aload_0
    //   76: invokevirtual 104	com/google/android/gms/analytics/internal/zzah:zziD	()Z
    //   79: ifeq +35 -> 114
    //   82: aload_0
    //   83: ldc -21
    ...
    //   178: aload_0
    //   179: invokevirtual 149	com/google/android/gms/analytics/internal/zzah:zzhP	()Lcom/google/android/gms/analytics/internal/zzb;
  ...
  {
    if (paramzzab.zzkC()) {}
    for (paramzzab = zziv().zzjO() + zziv().zzjQ() + "?" + paramString;; paramzzab = zziv().zzjP() + zziv().zzjQ() + "?" + paramString) {
      try
      {
  ...
  private boolean zzg(zzab paramzzab)
  {
    ...
    do
    {
      do
      {
        ...
        bool = false;
        break;
        if (((String)localObject).length() > zziv().zzjD()) {
          break label90;
        }
      ...
      if (localObject.length > zziv().zzjF())
      {
  ...
  {
    if (paramzzab.zzkC()) {}
    for (paramzzab = zziv().zzjO() + zziv().zzjQ();; paramzzab = zziv().zzjP() + zziv().zzjQ()) {
      try
      {
        paramzzab = new URL(paramzzab);
        return paramzzab;
  ...
  private URL zzkL()
  {
    Object localObject = zziv().zzjO() + zziv().zzjR();
    try
    {
  ...
  String zza(zzab paramzzab, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      zza(localStringBuilder, "ht", String.valueOf(paramzzab.zzkA()));
    }
    ...
    zza(localStringBuilder, "qt", String.valueOf(zzit().currentTimeMillis() - paramzzab.zzkA()));
    if (zziv().zzjA()) {
  ...
  List<Long> zza(List<zzab> paramList, boolean paramBoolean)
  {
    ...
    {
      zza("Batched upload completed. Hits batched", Integer.valueOf(localzza.zzkN()));
      return localArrayList;
    }
  ...
  public List<Long> zzm(List<zzab> paramList)
  {
    boolean bool = true;
    zzis();
    zziE();
    zzx.zzw(paramList);
    int j;
    if ((zziv().zzjU().isEmpty()) || (!this.zzPx.zzv(zziv().zzjN() * 1000L)))
    {
      bool = false;
      j = 0;
      if (j != 0) {
    ...
    return zzn(paramList);
  }
  
  List<Long> zzn(List<zzab> paramList)
  {
    ...
    do
    {
      ...
      localArrayList.add(Long.valueOf(localzzab.zzkz()));
    } while (localArrayList.size() < zziv().zzjL());
    return localArrayList;
  }
  ...
  private class zza
  {
    ...
    public boolean zzj(zzab paramzzab)
    {
      ...
      if (i + this.zzPA.size() > zzah.this.zziv().zzjG()) {
        return false;
      }
      try
      {
        if (this.zzPA.size() > 0) {
          this.zzPA.write(zzah.zzkM());
        }
        this.zzPA.write((byte[])localObject);
        this.zzPz += 1;
        return true;
      }
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\analytics\internal\zzah.class
