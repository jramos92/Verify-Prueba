  ...
  private T zza(XmlResourceParser paramXmlResourceParser)
  {
    for (;;)
    {
      ...
      if ((!TextUtils.isEmpty(str1)) && (str2 != null)) {
        this.zzNS.zzm(str1, str2);
      }
    }
  }
  
  public T zzad(int paramInt)
  {
    try
    {
      zzp localzzp = zza(zziq().zziG().getResources().getXml(paramInt));
      return localzzp;
    }
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\analytics\internal\zzq.class
