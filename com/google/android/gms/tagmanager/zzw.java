...
{
  private static final String zzaWF = String.format("CREATE TABLE IF NOT EXISTS %s ( '%s' INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, '%s' STRING NOT NULL, '%s' BLOB NOT NULL, '%s' INTEGER NOT NULL);", new Object[] { "datalayer", "ID", "key", "value", "expires" });
  ...
  {
    this(paramContext, zzmp.zzqt(), "google_tagmanager.db", 2000, Executors.newSingleThreadExecutor());
  }
  
  zzw(Context paramContext, zzmn paramzzmn, String paramString, int paramInt, Executor paramExecutor)
  {
    this.mContext = paramContext;
    this.zzpW = paramzzmn;
    this.zzaWI = paramInt;
    this.zzaWG = paramExecutor;
    this.zzaWH = new zza(this.mContext, paramString);
  }
  
  private List<DataLayer.zza> zzCJ()
  {
    try
    {
      zzV(this.zzpW.currentTimeMillis());
      List localList = zzx(zzCK());
      return localList;
    }
    finally
    {
  ...
  {
    Object localObject = zzeM("Error opening database for loadSerialized.");
  ...
  private int zzCL()
  {
    ...
    int i = 0;
    int j = 0;
    Object localObject5 = zzeM("Error opening database for getNumStoredEntries.");
  ...
  /* Error */
  private byte[] zzI(Object paramObject)
  {
    // Byte code:
    //   0: new 189	java/io/ByteArrayOutputStream
    //   3: dup
    //   4: invokespecial 190	java/io/ByteArrayOutputStream:<init>	()V
    //   7: astore_3
    //   8: new 192	java/io/ObjectOutputStream
    //   11: dup
    //   12: aload_3
    //   13: invokespecial 195	java/io/ObjectOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   16: astore_2
    //   17: aload_2
    //   18: aload_1
    //   19: invokevirtual 199	java/io/ObjectOutputStream:writeObject	(Ljava/lang/Object;)V
    //   22: aload_3
    //   23: invokevirtual 203	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   26: astore_1
    //   27: aload_2
    //   28: ifnull +7 -> 35
    //   31: aload_2
    //   32: invokevirtual 204	java/io/ObjectOutputStream:close	()V
    //   35: aload_3
    //   36: invokevirtual 205	java/io/ByteArrayOutputStream:close	()V
    //   39: aload_1
    //   40: areturn
    //   41: astore_1
    //   42: aconst_null
    ...
    //   45: ifnull +7 -> 52
    //   48: aload_2
    //   49: invokevirtual 204	java/io/ObjectOutputStream:close	()V
    //   52: aload_3
    //   53: invokevirtual 205	java/io/ByteArrayOutputStream:close	()V
    //   56: aconst_null
    //   57: areturn
    //   58: astore_1
    //   59: aconst_null
    ...
    //   65: ifnull +7 -> 72
    //   68: aload_2
    //   69: invokevirtual 204	java/io/ObjectOutputStream:close	()V
    //   72: aload_3
    //   73: invokevirtual 205	java/io/ByteArrayOutputStream:close	()V
    //   76: aload_1
    //   77: athrow
    //   78: astore_2
    //   79: goto -3 -> 76
  ...
  {
    SQLiteDatabase localSQLiteDatabase = zzeM("Error opening database for deleteOlderThan.");
  ...
  private void zzb(List<zzb> paramList, long paramLong)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 78	com/google/android/gms/tagmanager/zzw:zzpW	Lcom/google/android/gms/internal/zzmn;
    //   6: invokeinterface 95 1 0
    //   11: lstore 4
    //   13: aload_0
    //   14: lload 4
    //   16: invokespecial 99	com/google/android/gms/tagmanager/zzw:zzV	(J)V
    //   19: aload_0
    //   20: aload_1
    //   21: invokeinterface 255 1 0
    //   26: invokespecial 259	com/google/android/gms/tagmanager/zzw:zzjt	(I)V
    //   29: aload_0
    //   30: aload_1
    //   31: lload 4
    //   33: lload_2
    //   34: ladd
    //   35: invokespecial 262	com/google/android/gms/tagmanager/zzw:zzc	(Ljava/util/List;J)V
    //   38: aload_0
    //   39: invokespecial 109	com/google/android/gms/tagmanager/zzw:zzCM	()V
    //   42: aload_0
    //   43: monitorexit
    //   44: return
    //   45: astore_1
    //   46: aload_0
    //   47: invokespecial 109	com/google/android/gms/tagmanager/zzw:zzCM	()V
    //   50: aload_1
    //   51: athrow
    //   52: astore_1
    //   53: aload_0
  ...
  {
    SQLiteDatabase localSQLiteDatabase = zzeM("Error opening database for writeEntryToDatabase.");
    if (localSQLiteDatabase == null) {}
    for (;;)
    {
      return;
      ...
      while (paramList.hasNext())
      {
        ...
        localContentValues.put("key", localzzb.zzue);
        localContentValues.put("value", localzzb.zzaWO);
  ...
  private void zze(String[] paramArrayOfString)
  {
    ...
    {
      return;
      localSQLiteDatabase = zzeM("Error opening database for deleteEntries.");
  ...
  {
    SQLiteDatabase localSQLiteDatabase = zzeM("Error opening database for clearKeysWithPrefix.");
    if (localSQLiteDatabase == null) {
      return;
    }
    try
  ...
  private SQLiteDatabase zzeM(String paramString)
  {
    try
    {
      SQLiteDatabase localSQLiteDatabase = this.zzaWH.getWritableDatabase();
  ...
  private void zzjt(int paramInt)
  {
    paramInt = zzCL() - this.zzaWI + paramInt;
    if (paramInt > 0)
    {
      List localList = zzju(paramInt);
  ...
  /* Error */
  private List<String> zzju(int paramInt)
  {
    // Byte code:
    ...
    //   10: ifgt +12 -> 22
    //   13: ldc_w 380
    //   16: invokestatic 180	com/google/android/gms/tagmanager/zzbg:zzaH	(Ljava/lang/String;)V
    //   19: aload 6
    //   21: areturn
    //   22: aload_0
    //   23: ldc_w 382
    //   26: invokespecial 117	com/google/android/gms/tagmanager/zzw:zzeM	(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    //   29: astore_3
    //   30: aload_3
    //   31: ifnonnull +6 -> 37
    //   34: aload 6
    ...
    //   52: astore 4
    //   54: iload_1
    //   55: invokestatic 388	java/lang/Integer:toString	(I)Ljava/lang/String;
    //   58: astore 5
    //   60: aload_3
    //   61: ldc 36
    //   63: iconst_1
    ...
    //   76: aload 4
    //   78: aload 5
    //   80: invokevirtual 126	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   83: astore 4
    //   85: aload 4
    //   87: astore_3
    //   88: aload 4
    ...
    //   111: invokestatic 390	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   114: invokeinterface 149 2 0
    //   119: pop
    //   120: aload 4
    //   122: astore_3
    //   123: aload 4
    ...
    //   155: aload 4
    //   157: astore_3
    //   158: new 221	java/lang/StringBuilder
    //   161: dup
    //   162: invokespecial 222	java/lang/StringBuilder:<init>	()V
    //   165: ldc_w 392
    //   168: invokevirtual 228	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   171: aload 5
    //   173: invokevirtual 395	android/database/sqlite/SQLiteException:getMessage	()Ljava/lang/String;
    //   176: invokevirtual 228	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   179: invokevirtual 235	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   182: invokestatic 180	com/google/android/gms/tagmanager/zzbg:zzaH	(Ljava/lang/String;)V
    //   185: aload 4
    //   187: ifnull -40 -> 147
    //   190: aload 4
  ...
  /* Error */
  private Object zzu(byte[] paramArrayOfByte)
  {
    // Byte code:
    //   0: new 402	java/io/ByteArrayInputStream
    //   3: dup
    //   4: aload_1
    //   5: invokespecial 405	java/io/ByteArrayInputStream:<init>	([B)V
    //   8: astore_3
    //   9: new 407	java/io/ObjectInputStream
    //   12: dup
    //   13: aload_3
    //   14: invokespecial 410	java/io/ObjectInputStream:<init>	(Ljava/io/InputStream;)V
    //   17: astore_1
    //   18: aload_1
    //   19: invokevirtual 413	java/io/ObjectInputStream:readObject	()Ljava/lang/Object;
    //   22: astore_2
    //   23: aload_1
    //   24: ifnull +7 -> 31
    //   27: aload_1
    //   28: invokevirtual 414	java/io/ObjectInputStream:close	()V
    //   31: aload_3
    //   32: invokevirtual 415	java/io/ByteArrayInputStream:close	()V
    //   35: aload_2
    //   36: areturn
    //   37: astore_1
    //   38: aconst_null
    ...
    //   41: ifnull +7 -> 48
    //   44: aload_1
    //   45: invokevirtual 414	java/io/ObjectInputStream:close	()V
    //   48: aload_3
    //   49: invokevirtual 415	java/io/ByteArrayInputStream:close	()V
    //   52: aconst_null
    //   53: areturn
    //   54: astore_1
    //   55: aconst_null
    ...
    //   61: ifnull +7 -> 68
    //   64: aload_1
    //   65: invokevirtual 414	java/io/ObjectInputStream:close	()V
    //   68: aload_3
    //   69: invokevirtual 415	java/io/ByteArrayInputStream:close	()V
    //   72: aconst_null
    //   73: areturn
    //   74: astore_1
    //   75: aconst_null
    ...
    //   81: ifnull +7 -> 88
    //   84: aload_1
    //   85: invokevirtual 414	java/io/ObjectInputStream:close	()V
    //   88: aload_3
    //   89: invokevirtual 415	java/io/ByteArrayInputStream:close	()V
    //   92: aload_2
    //   93: athrow
    //   94: astore_1
    //   95: goto -3 -> 92
  ...
  private List<DataLayer.zza> zzx(List<zzb> paramList)
  {
    ArrayList localArrayList = new ArrayList();
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      zzb localzzb = (zzb)paramList.next();
      localArrayList.add(new DataLayer.zza(localzzb.zzue, zzu(localzzb.zzaWO)));
    }
    return localArrayList;
  }
  
  private List<zzb> zzy(List<DataLayer.zza> paramList)
  {
    ArrayList localArrayList = new ArrayList();
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      ...
      localArrayList.add(new zzb(localzza.zzue, zzI(localzza.zzJy)));
    }
    return localArrayList;
  }
  ...
  {
    this.zzaWG.execute(new Runnable()
    {
      public void run()
      {
        paramzza.zzw(zzw.zza(zzw.this));
      }
    });
  }
  ...
  public void zzeK(final String paramString)
  {
    this.zzaWG.execute(new Runnable()
    {
      public void run()
    ...
    extends SQLiteOpenHelper
  {
    ...
    public void onOpen(SQLiteDatabase paramSQLiteDatabase)
    {
      ...
      try
      {
        ...
        {
          paramSQLiteDatabase.execSQL(zzw.zzCN());
          return;
        }
      }
      finally
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\tagmanager\zzw.class
