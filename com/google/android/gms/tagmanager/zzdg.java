  ...
  extends zzdd
{
  ...
  private static final String zzaZS = zzae.zzdl.toString();
  private static final String zzaZT = zzae.zzdv.toString();
  private static final String zzaZU = zzae.zzeQ.toString();
  private static final String zzaZV = zzae.zzeK.toString();
  private static final String zzaZW = zzae.zzeJ.toString();
  private static final String zzaZX = zzae.zzdu.toString();
  private static final String zzaZY = zzae.zzhn.toString();
  private static final String zzaZZ = zzae.zzhq.toString();
  private static final String zzbaa = zzae.zzhs.toString();
  private static final List<String> zzbab = Arrays.asList(new String[] { "detail", "checkout", "checkout_option", "click", "add", "remove", "purchase", "refund" });
  ...
  private Product zzT(Map<String, Object> paramMap)
  {
    ...
    if (localObject != null) {
      localProduct.setPosition(zzV(localObject).intValue());
    }
    localObject = paramMap.get("price");
    if (localObject != null) {
      localProduct.setPrice(zzU(localObject).doubleValue());
    }
    localObject = paramMap.get("quantity");
    if (localObject != null) {
      localProduct.setQuantity(zzV(localObject).intValue());
    }
    localObject = paramMap.keySet().iterator();
    while (((Iterator)localObject).hasNext())
    {
      String str = (String)((Iterator)localObject).next();
      Matcher localMatcher1 = zzbac.matcher(str);
      int i;
      ...
      {
        Matcher localMatcher2 = zzbad.matcher(str);
        if (localMatcher2.matches()) {
          try
          {
            i = Integer.parseInt(localMatcher2.group(1));
            localProduct.setCustomMetric(i, zzV(paramMap.get(str)).intValue());
          }
  ...
  private Double zzU(Object paramObject)
  {
  ...
  {
    paramMap = (zzag.zza)paramMap.get(zzaZZ);
    if (paramMap != null) {
      return zzc(paramMap);
    }
    if (zzbae == null)
  ...
  private Integer zzV(Object paramObject)
  {
    if ((paramObject instanceof String)) {
      try
      {
  ...
  {
    paramMap = (zzag.zza)paramMap.get(zzbaa);
    if (paramMap != null) {
      return zzc(paramMap);
    }
    if (zzbaf == null)
  ...
  private void zza(Tracker paramTracker, Map<String, zzag.zza> paramMap)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localObject1 = zzm((zzag.zza)paramMap.get(zzaZX));
        ((Map)localObject1).put("&t", "transaction");
        localObject2 = zzU(paramMap).entrySet().iterator();
        while (((Iterator)localObject2).hasNext())
        {
          localObject3 = (Map.Entry)((Iterator)localObject2).next();
          zze((Map)localObject1, (String)((Map.Entry)localObject3).getValue(), zzfj((String)((Map.Entry)localObject3).getKey()));
        }
      ...
      Object localObject1 = zzfk("transactionProducts");
      if (localObject1 != null)
      {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          localObject3 = zzm((zzag.zza)paramMap.get(zzaZX));
  ...
  private void zzb(Tracker paramTracker, Map<String, zzag.zza> paramMap)
  {
    ...
    Object localObject1 = zzm((zzag.zza)paramMap.get(zzaZX));
    localScreenViewBuilder.setAll((Map)localObject1);
    if (zzj(paramMap, zzaZV))
    {
      paramMap = this.zzaVR.get("ecommerce");
    ...
    for (;;)
    {
        ...
        if ((localObject1 instanceof List))
        {
          ...
          for (;;)
          {
            if (((Iterator)localObject1).hasNext())
            {
              ...
              continue;
              paramMap = zzdf.zzl((zzag.zza)paramMap.get(zzaZW));
              if (!(paramMap instanceof Map)) {
                break label726;
              }
              paramMap = (Map)paramMap;
      ...
      for (;;)
      {
        ...
        for (int i = 0;; i = 1)
        {
          ...
          Object localObject3 = zzbab.iterator();
          do
          {
  ...
  private ProductAction zzd(String paramString, Map<String, Object> paramMap)
  {
    ...
    if (localObject != null) {
      paramString.setTransactionRevenue(zzU(localObject).doubleValue());
    }
    localObject = paramMap.get("tax");
    if (localObject != null) {
      paramString.setTransactionTax(zzU(localObject).doubleValue());
    }
    localObject = paramMap.get("shipping");
    if (localObject != null) {
      paramString.setTransactionShipping(zzU(localObject).doubleValue());
    }
    paramMap = paramMap.get("step");
    if (paramMap != null) {
      paramString.setCheckoutStep(zzV(paramMap).intValue());
    }
    return paramString;
  }
  ...
  private String zzfj(String paramString)
  {
    paramString = this.zzaVR.get(paramString);
    if (paramString == null) {
      return null;
    }
  ...
  private List<Map<String, String>> zzfk(String paramString)
  {
    paramString = this.zzaVR.get(paramString);
    if (paramString == null) {
      return null;
  ...
  {
    Tracker localTracker = this.zzbah.zzfb("_GTM_DEFAULT_TRACKER_");
    localTracker.enableAdvertisingIdCollection(zzj(paramMap, "collect_adid"));
    if (zzj(paramMap, zzaZU))
    {
      zzb(localTracker, paramMap);
      return;
    }
    if (zzj(paramMap, zzaZT))
    {
      localTracker.send(zzm((zzag.zza)paramMap.get(zzaZX)));
      return;
    }
    if (zzj(paramMap, zzaZY))
    {
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\tagmanager\zzdg.class
