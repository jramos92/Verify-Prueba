...
class zzby
  implements zzau
{
  private static final String zzNm = String.format("CREATE TABLE IF NOT EXISTS %s ( '%s' INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, '%s' INTEGER NOT NULL, '%s' TEXT NOT NULL,'%s' INTEGER NOT NULL);", new Object[] { "gtm_hits", "hit_id", "hit_time", "hit_url", "hit_first_send_time" });
  ...
  private void zzDi()
  {
    int i = zzDj() - this.zzaXN + 1;
    if (i > 0)
    {
      List localList = zzjz(i);
  ...
  {
    SQLiteDatabase localSQLiteDatabase = zzeM("Error opening database for getNumStoredHits.");
  ...
  private SQLiteDatabase zzeM(String paramString)
  {
    try
    {
      SQLiteDatabase localSQLiteDatabase = this.zzaXI.getWritableDatabase();
  ...
  {
    SQLiteDatabase localSQLiteDatabase = zzeM("Error opening database for putHit");
    if (localSQLiteDatabase == null) {
      return;
    }
    ContentValues localContentValues = new ContentValues();
  ...
  int zzDj()
  {
    ...
    int i = 0;
    int j = 0;
    Object localObject5 = zzeM("Error opening database for getNumStoredHits.");
  ...
  int zzDk()
  {
    ...
    //   3: aload_0
    //   4: ldc -86
    //   6: invokespecial 174	com/google/android/gms/tagmanager/zzby:zzeM	(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    //   9: astore_3
    //   10: aload_3
    //   11: ifnonnull +5 -> 16
    //   14: iconst_0
  ...
  void zzf(String[] paramArrayOfString)
  {
    ...
    {
      return;
      localSQLiteDatabase = zzeM("Error opening database for deleteHits.");
  ...
  int zziW()
  {
    ...
    if (l <= this.zzaXM + 86400000L) {}
    do
    {
      return 0;
      this.zzaXM = l;
      localObject = zzeM("Error opening database for deleteStaleHits.");
  ...
  /* Error */
  public List<zzaq> zzjA(int paramInt)
  {
    // Byte code:
    //   0: new 352	java/util/ArrayList
    //   3: dup
    //   4: invokespecial 353	java/util/ArrayList:<init>	()V
    //   7: astore 5
    //   9: aload_0
    //   10: ldc_w 355
    //   13: invokespecial 174	com/google/android/gms/tagmanager/zzby:zzeM	(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    //   16: astore 8
    //   18: aload 8
    //   20: ifnonnull +10 -> 30
    //   23: aload 5
    ...
    //   92: aload 6
    //   94: astore 4
    //   96: new 352	java/util/ArrayList
    //   99: dup
    //   100: invokespecial 353	java/util/ArrayList:<init>	()V
    //   103: astore 7
    //   105: aload 4
    //   107: invokeinterface 280 1 0
    //   112: ifeq +54 -> 166
    //   115: aload 7
    //   117: new 365	com/google/android/gms/tagmanager/zzaq
    //   120: dup
    //   121: aload 4
    //   123: iconst_0
    ...
    //   145: invokespecial 368	com/google/android/gms/tagmanager/zzaq:<init>	(JJJ)V
    //   148: invokeinterface 372 2 0
    //   153: pop
    //   154: aload 4
    ...
    //   255: istore_1
    //   256: aload 6
    //   258: checkcast 377	android/database/sqlite/SQLiteCursor
    //   261: invokevirtual 381	android/database/sqlite/SQLiteCursor:getWindow	()Landroid/database/CursorWindow;
    //   264: invokevirtual 386	android/database/CursorWindow:getNumRows	()I
    //   267: ifle +136 -> 403
    //   270: aload 7
    //   272: iload_1
    //   273: invokeinterface 390 2 0
    //   278: checkcast 365	com/google/android/gms/tagmanager/zzaq
    //   281: aload 6
    //   283: iconst_1
    //   284: invokeinterface 393 2 0
    //   289: invokevirtual 396	com/google/android/gms/tagmanager/zzaq:zzeQ	(Ljava/lang/String;)V
    //   292: aload 6
    ...
    //   345: aload 6
    //   347: invokevirtual 401	android/database/sqlite/SQLiteException:getMessage	()Ljava/lang/String;
    ...
    //   412: aload 7
    //   414: iload_1
    //   415: invokeinterface 390 2 0
    //   420: checkcast 365	com/google/android/gms/tagmanager/zzaq
    //   423: invokevirtual 406	com/google/android/gms/tagmanager/zzaq:zzCV	()J
    ...
    //   466: aload 6
    //   468: invokevirtual 401	android/database/sqlite/SQLiteException:getMessage	()Ljava/lang/String;
    ...
    //   480: aload 4
    //   482: astore 5
    //   484: new 352	java/util/ArrayList
    //   487: dup
    //   488: invokespecial 353	java/util/ArrayList:<init>	()V
    //   491: astore 6
    //   493: iconst_0
    //   494: istore_1
    //   495: aload 4
    //   497: astore 5
    //   499: aload 7
    //   501: invokeinterface 412 1 0
    //   506: astore 7
    //   508: aload 4
    //   510: astore 5
    //   512: aload 7
    //   514: invokeinterface 417 1 0
    //   519: ifeq +42 -> 561
    //   522: aload 4
    //   524: astore 5
    //   526: aload 7
    //   528: invokeinterface 421 1 0
    //   533: checkcast 365	com/google/android/gms/tagmanager/zzaq
    //   536: astore 8
    //   538: aload 4
    //   540: astore 5
    //   542: aload 8
    //   544: invokevirtual 424	com/google/android/gms/tagmanager/zzaq:zzCX	()Ljava/lang/String;
    //   547: invokestatic 427	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   550: istore_3
    //   551: iload_1
    //   552: istore_2
    //   553: iload_3
  ...
  List<String> zzjz(int paramInt)
  {
    ...
    //   22: aload_0
    //   23: ldc_w 433
    //   26: invokespecial 174	com/google/android/gms/tagmanager/zzby:zzeM	(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    //   29: astore_3
    //   30: aload_3
    //   31: ifnonnull +6 -> 37
    //   34: aload 6
    ...
    //   171: aload 5
    //   173: invokevirtual 401	android/database/sqlite/SQLiteException:getMessage	()Ljava/lang/String;
    ...
    implements zzcx.zza
  {
    ...
    {
      zzby.zza(zzby.this, paramzzaq.zzCV());
    }
    
    public void zzb(zzaq paramzzaq)
    {
      zzby.zza(zzby.this, paramzzaq.zzCV());
      zzbg.v("Permanent failure dispatching hitId: " + paramzzaq.zzCV());
    }
    
    public void zzc(zzaq paramzzaq)
    {
      long l = paramzzaq.zzCW();
      if (l == 0L) {
        zzby.zza(zzby.this, paramzzaq.zzCV(), zzby.zza(zzby.this).currentTimeMillis());
      }
      while (l + 14400000L >= zzby.zza(zzby.this).currentTimeMillis()) {
        return;
      }
      zzby.zza(zzby.this, paramzzaq.zzCV());
      zzbg.v("Giving up on failed hitId: " + paramzzaq.zzCV());
    }
  }
    ...
    extends SQLiteOpenHelper
  {
    ...
    {
      if ((this.zzaXP) && (this.zzaXQ + 3600000L > zzby.zza(zzby.this).currentTimeMillis())) {
        throw new SQLiteException("Database creation failed");
      }
      Object localObject1 = null;
      this.zzaXP = true;
      this.zzaXQ = zzby.zza(zzby.this).currentTimeMillis();
      try
      {
    ...
    public void onOpen(SQLiteDatabase paramSQLiteDatabase)
    {
      ...
      try
      {
        ...
        {
          paramSQLiteDatabase.execSQL(zzby.zzDl());
          return;
        }
      }
      finally
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\tagmanager\zzby.class
