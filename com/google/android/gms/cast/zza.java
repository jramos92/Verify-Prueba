  ...
  implements Parcelable.Creator<ApplicationMetadata>
{
  static void zza(ApplicationMetadata paramApplicationMetadata, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zzb(paramParcel, 5, paramApplicationMetadata.zzUN, false);
    zzb.zza(paramParcel, 6, paramApplicationMetadata.getSenderAppIdentifier(), false);
    zzb.zza(paramParcel, 7, paramApplicationMetadata.zzmj(), paramInt, false);
    zzb.zzI(paramParcel, i);
  }
  
  public ApplicationMetadata zzW(Parcel paramParcel)
  {
    Uri localUri = null;
  ...
  public ApplicationMetadata[] zzaN(int paramInt)
  {
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\cast\zza.class
