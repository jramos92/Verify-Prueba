    ...
    throws IllegalArgumentException
  {
    ...
    if (paramCollection != null)
    {
      ...
      if (paramString2.hasNext())
      {
        ...
        zzf.zzbM(paramCollection);
        if (i != 0) {
          i = 0;
        }
        for (;;)
        {
          paramString1.append(zzf.zzbO(paramCollection));
          break;
          paramString1.append(",");
        }
      }
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\cast\CastMediaControlIntent.class
