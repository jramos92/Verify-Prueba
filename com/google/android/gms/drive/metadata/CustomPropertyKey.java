  ...
  implements SafeParcelable
{
  ...
  CustomPropertyKey(int paramInt1, String paramString, int paramInt2)
  {
    ...
    zzx.zzb(zzamz.matcher(paramString).matches(), "key name characters must be alphanumeric or one of .!@$%^&*()-_/");
    boolean bool1 = bool2;
    if (paramInt2 != 0) {
      if (paramInt2 != 1) {
        break label69;
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if ((((CustomPropertyKey)paramObject).getKey().equals(this.zzue)) && (((CustomPropertyKey)paramObject).getVisibility() == this.mVisibility)) {}
    for (;;)
    {
      return bool;
      bool = false;
  ...
  public int hashCode()
  {
    return (this.zzue + this.mVisibility).hashCode();
  }
  ...
  {
    return "CustomPropertyKey(" + this.zzue + "," + this.mVisibility + ")";
  }
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\drive\metadata\CustomPropertyKey.class
