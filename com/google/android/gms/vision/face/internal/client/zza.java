  ...
  implements Parcelable.Creator<FaceParcel>
{
  static void zza(FaceParcel paramFaceParcel, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 7, paramFaceParcel.zzbbR);
    zzb.zza(paramParcel, 8, paramFaceParcel.zzbbS);
    zzb.zza(paramParcel, 9, paramFaceParcel.zzbbT, paramInt, false);
    zzb.zza(paramParcel, 10, paramFaceParcel.zzbbU);
    zzb.zza(paramParcel, 11, paramFaceParcel.zzbbV);
    zzb.zza(paramParcel, 12, paramFaceParcel.zzbbW);
    zzb.zzI(paramParcel, i);
  }
  
  public FaceParcel zzgS(Parcel paramParcel)
  {
  ...
  public FaceParcel[] zzjU(int paramInt)
  {
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\vision\face\internal\client\zza.class
