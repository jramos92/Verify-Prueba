  ...
  implements Parcelable.Creator<DataReadResult>
{
  static void zza(DataReadResult paramDataReadResult, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zzd(paramParcel, 1, paramDataReadResult.zztp(), false);
    ...
    zzb.zzd(paramParcel, 3, paramDataReadResult.zzto(), false);
    zzb.zzc(paramParcel, 5, paramDataReadResult.zztn());
    zzb.zzc(paramParcel, 6, paramDataReadResult.zzsq(), false);
    zzb.zzc(paramParcel, 7, paramDataReadResult.zztq(), false);
    zzb.zzI(paramParcel, i);
  }
  
  public DataReadResult zzdC(Parcel paramParcel)
  {
    int i = 0;
  ...
  public DataReadResult[] zzfu(int paramInt)
  {
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\fitness\result\zzc.class
