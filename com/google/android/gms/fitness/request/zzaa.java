  ...
  implements Parcelable.Creator<StartBleScanRequest>
{
  static void zza(StartBleScanRequest paramStartBleScanRequest, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 2, paramStartBleScanRequest.zztk(), false);
    zzb.zzc(paramParcel, 3, paramStartBleScanRequest.getTimeoutSecs());
    zzb.zza(paramParcel, 4, paramStartBleScanRequest.zzsO(), false);
    zzb.zzI(paramParcel, paramInt);
  }
  
  public StartBleScanRequest zzdv(Parcel paramParcel)
  {
    int i = 0;
  ...
  public StartBleScanRequest[] zzfn(int paramInt)
  {
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\fitness\request\zzaa.class
