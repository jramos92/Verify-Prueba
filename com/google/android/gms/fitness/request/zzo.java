  ...
  implements Parcelable.Creator<ListClaimedBleDevicesRequest>
{
  static void zza(ListClaimedBleDevicesRequest paramListClaimedBleDevicesRequest, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 1, paramListClaimedBleDevicesRequest.zzsO(), false);
    zzb.zzc(paramParcel, 1000, paramListClaimedBleDevicesRequest.getVersionCode());
    zzb.zzI(paramParcel, paramInt);
  }
  
  public ListClaimedBleDevicesRequest zzdj(Parcel paramParcel)
  {
  ...
  public ListClaimedBleDevicesRequest[] zzfa(int paramInt)
  {
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\fitness\request\zzo.class
