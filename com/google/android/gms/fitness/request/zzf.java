  ...
  implements Parcelable.Creator<DataReadRequest>
{
  static void zza(DataReadRequest paramDataReadRequest, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 3, paramDataReadRequest.zzkX());
    zzb.zza(paramParcel, 4, paramDataReadRequest.zzsi());
    ...
    zzb.zza(paramParcel, 8, paramDataReadRequest.zzsV());
    ...
    zzb.zza(paramParcel, 12, paramDataReadRequest.zzsU());
    zzb.zza(paramParcel, 13, paramDataReadRequest.zzsT());
    zzb.zza(paramParcel, 14, paramDataReadRequest.zzsO(), false);
    zzb.zzc(paramParcel, 16, paramDataReadRequest.zzsW(), false);
    zzb.zzc(paramParcel, 1000, paramDataReadRequest.getVersionCode());
    zzb.zzI(paramParcel, i);
  }
  
  public DataReadRequest zzdb(Parcel paramParcel)
  {
  ...
  public DataReadRequest[] zzeS(int paramInt)
  {
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\fitness\request\zzf.class
