  ...
  implements Parcelable.Creator<FitnessSensorServiceRequest>
{
  static void zza(FitnessSensorServiceRequest paramFitnessSensorServiceRequest, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 2, paramFitnessSensorServiceRequest.zztf(), false);
    zzb.zza(paramParcel, 3, paramFitnessSensorServiceRequest.zzsB());
    zzb.zza(paramParcel, 4, paramFitnessSensorServiceRequest.zztw());
    zzb.zzI(paramParcel, i);
  }
  
  public FitnessSensorServiceRequest zzdM(Parcel paramParcel)
  {
    long l1 = 0L;
  ...
  public FitnessSensorServiceRequest[] zzfE(int paramInt)
  {
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\fitness\service\zza.class
