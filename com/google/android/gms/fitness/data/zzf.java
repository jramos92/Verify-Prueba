  ...
  implements Parcelable.Creator<DataSource>
{
  static void zza(DataSource paramDataSource, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 5, paramDataSource.zzsr(), paramInt, false);
    zzb.zza(paramParcel, 6, paramDataSource.getStreamName(), false);
    zzb.zzI(paramParcel, i);
  }
  
  public DataSource zzcJ(Parcel paramParcel)
  {
    int i = 0;
    String str1 = null;
  ...
  public DataSource[] zzez(int paramInt)
  {
...
/* Location:              C:\Users\julian\Downloads\Veryfit 2 0_vV2.0.28_apkpure.com-dex2jar.jar!\com\google\android\gms\fitness\data\zzf.class
